...
def test_extract_converted_f0(
    ...
    extract_converted_f0(
        input_glob=true_data_base_dir / f'output_extract_f0-with_vuv={with_vuv}' / '*.npy',
    ...
    true_data_dir = true_data_base_dir / f'output_extract_converted_f0-with_vuv={with_vuv}'
